...
lectures1 = [(30, 75), (0, 50), (60, 150)]
lectures2 = [(30, 75), (0, 50), (60, 150), (0, 500), (40, 70)]
# print('Max Rooms', find_nr_rooms(lectures))       
print('Max Rooms Fast', find_nr_rooms_fast(lectures1))  
print('Max Rooms Fast', find_nr_rooms_fast(lectures2))   